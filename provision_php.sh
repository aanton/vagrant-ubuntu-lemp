...
sudo apt-get install -qq php5-curl php5-gd php5-imagick php5-json php5-mcrypt
sudo apt-get install -qq php5-mysql php5-sqlite
sudo apt-get install -qq php5-memcached
...
sudo apt-get install -qq php5-fpm
...
sudo sed -i "s/.*opcache.enable=.*/opcache.enable=1/" /etc/php5/fpm/php.ini
sudo sed -i "s/.*opcache.fast_shutdown=.*/opcache.fast_shutdown=1/" /etc/php5/fpm/php.ini
sudo sed -i "s/.*opcache.interned_strings_buffer=.*/opcache.interned_strings_buffer=8/" /etc/php5/fpm/php.ini
sudo sed -i "s/.*opcache.max_accelerated_files=.*/opcache.max_accelerated_files=4000/" /etc/php5/fpm/php.ini
sudo sed -i "s/.*opcache.memory_consumption=.*/opcache.memory_consumption=64/" /etc/php5/fpm/php.ini
sudo sed -i "s/.*opcache.revalidate_freq=.*/opcache.revalidate_freq=0/" /etc/php5/fpm/php.ini
sudo sed -i "s/.*opcache.validate_timestamps=.*/opcache.validate_timestamps=1/" /etc/php5/fpm/php.ini
